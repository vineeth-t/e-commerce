...
export function ProductCard({name,image,price,whereIsProduct}){
    ...
    return (
        <div className="card-overlay">
                ...
                <button className="wishlist-l" 
                    onClick={()=>setWishlistItems((item)=>[...item,{name,image,price}])}>
                ...
                <br/>
                {whereIsProduct==='Whislist'&&<button className="wishlist-l">X</button>}
                {(whereIsProduct==='Product'|| whereIsProduct==='Whislist') &&
