...
import './card.css'
export function ProductCard({productItem,whereIsProduct,setToast}){
    ...
    return (
        ...
        <div className="card-overlay">
                ...
                <span className="Item Item-discountPercentage">(50% off) </span> 
                    {whereIsProduct==='inProductPage' &&
                        <button className="wishlist-l" 
                            onClick={()=>dispatch({type:'Add2Wishlist',product:{id,name,image,price}})}>
             ...
             {whereIsProduct==='inWishlist' &&
                     <button onClick={()=>dispatch({type:'deleteProduct',product:{id,name,image,price}})} className="wishlist-l">X</button>
             }
                <br/>
               
                <button className='btn-add2Cart' onClick={()=>dispatch({type:'Add2Cart',product:{id,name,image,price}})}>
                        Add to cart
                    </button>
