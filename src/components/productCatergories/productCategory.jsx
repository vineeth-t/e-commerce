  ...
  return (
    <div>
      ...
      <div className="item-catergories">
        <div
          className="catergory-img"
          style={{ background: `url(${camera})no-repeat center/100% 100%` }}
        >
          <span>Cameras</span>
          <span>Flat 30%</span>
        </div>
        <div
          className="catergory-img"
          style={{ background: `url(${fashion})no-repeat center/100% 100%` }}
        >
          <span>Tshirts</span>
        ...
        <div
          className="catergory-img"
          style={{ background: `url(${music})no-repeat center/100% 100%` }}
        >
          <span>Earpods</span>
      ...
      <div>
        ...
        <div className="brand-types">
          <div
            className="catergory-img brand"
            style={{ background: `url(${apple})no-repeat center/100% 100%` }}
          />
          <div
            className="catergory-img brand"
            style={{ background: `url(${canon})no-repeat center/100% 100%` }}
          />
          <div
            className="catergory-img brand"
            style={{ background: `url(${marvel})no-repeat center/100% 100%` }}
          />
          <div
            className="catergory-img brand"
            style={{ background: `url(${sony})no-repeat center/100% 100%` }}
          />
        </div>
      </div>
    </div>
