...
export function Sort({showtheFilter,setTheFilter}){
    ...
    return<>
        <div className={showtheFilter==='sort-card'?'sort-card':'filterCard-radio-btn'}>
                <h4>SORT</h4>
        ...
        {showtheFilter==='sort-card'&&<button className='sort-card-close' onClick={()=>setTheFilter('')}>X</button>}
    </div>
    </>
}